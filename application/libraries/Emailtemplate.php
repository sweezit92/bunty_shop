...
class Emailtemplate {
	...
	public function contact_request($name,$mobile,$email,$message,$product_name){
											...
											<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
												<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
													...
													<tr>
														<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
															<multiline>
																You have received a contact request from :<br>
																Name: <span style="color:#EC8C0E;">'. $name .'</span><br>
																Email: <span style="color:#EC8C0E;">' . $email . '</span><br>
																Mobile: <span style="color:#EC8C0E;">' . $mobile . '</span><br>
															</multiline>
														</td>
													</tr>
													...
													<tr>
														<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
															<multiline>
																For Product Name : <span style="color:#EC8C0E;">'. $product_name .'</span>
															</multiline>
														</td>
													</tr>
