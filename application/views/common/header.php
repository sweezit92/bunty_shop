<div class="topbar"> 
  ...
  <div class="header">
    <div class="container po-relative">
      <nav class="navbar navbar-expand-lg hover-dropdown header-nav-bar"> <a href="<?php echo base_url('home');?>" class="navbar-brand"><img src="<?php echo base_url();?>images/logo.png" alt="Vujubaba" style="height:60px;"> <!-- <span style="color:white;">LOGO</span>--></a>
