<div class="col-md-3">
	<div class="dashboard_menu">
	  ...
	  <ul class="list-unstyled  m-t-20">
	    ...
	    <li class="<?php echo(($this->uri->segment(2) == 'admin_add_sub_category')?'active':'');?>"><span><i class="fa fa-address-card"></i></span><a href="<?php echo base_url("admin_add_sub_category");?>"> Add Subcategory </a></li>
	    <li class="<?php echo(($this->uri->segment(2) == 'admin_view_sub_category')?'active':'');?>"><span><i class="fa fa-list"></i></span><a href="<?php echo base_url("admin_view_sub_category");?>"> View Subcategories </a></li>
